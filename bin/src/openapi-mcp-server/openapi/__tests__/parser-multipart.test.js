...
describe('OpenAPI Multipart Form Parser', () => {
    ...
    it('handles nested objects with file arrays in multipart forms', () => {
        ...
        const recordSchema = method.inputSchema.properties.record;
    ...
    it('handles oneOf/anyOf schemas with file uploads', () => {
        ...
        const contentSchema = method.inputSchema.properties.content;
...
//# sourceMappingURL=parser-multipart.test.js.map